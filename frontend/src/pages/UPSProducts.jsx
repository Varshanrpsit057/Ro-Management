...
export default function UPSProducts() {
  ...
  useEffect(() => {
    API.get("/categories?store_type=ups").then((r) => setCategories(r.data));
  }, []);

  useEffect(() => {
    setLoading(true);
    const params = { store_type: "ups" };
  ...
  return (
    <div className="store-page">
      <section className="store-hero ups-hero-banner">
        <div className="store-hero-content fade-in">
          <h1>PowerZone UPS & Batteries</h1>
          <p>Home UPS • Office UPS • Inverters • Tubular Batteries • SMF Batteries • Stabilizers</p>
        </div>
      </section>
      ...
      <div className="store-container">
        <div className="store-controls">
          <input
            type="text"
            placeholder="Search UPS & battery products..."
            value={search}
